...
/* VERSION imposing limit of 3 on vertex degree */
...
/* This version: reject if vertex of degree > 3 */
    alpha = g[0];
    for (i = 1; i <= alpha; ++i)
	if (POPCOUNT(g[i]) > 3) return FALSE;
/* That's it. */
