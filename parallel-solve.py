...
def cube(file_to_cube, m, directory, order, numMCTS, logdir, queue):
    ...
    subprocess.run(f"./gen_cubes/apply.sh {file_to_cube} {directory}/{file_to_cube}.cubes 1 > {directory}/{file_to_cube}{1}.cubes", shell=True)
    subprocess.run(f"./gen_cubes/apply.sh {file_to_cube} {directory}/{file_to_cube}.cubes 2 > {directory}/{file_to_cube}{2}.cubes", shell=True)
